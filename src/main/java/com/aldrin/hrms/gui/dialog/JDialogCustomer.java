...
public class JDialogCustomer extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogCustomer(JFrameHRMS jFrameHRMS, boolean modal) {
...
//        jTextFieldSearch.putClientProperty( "JComponent.roundRect",true );
    ...
    private void jButtonNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNewActionPerformed
        JDialogCustomerAU categoryAU = new JDialogCustomerAU(jFrameHRMS, true);
        categoryAU.setVisible(true);
        selectRoomStatus();
    }//GEN-LAST:event_jButtonNewActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogCustomerAU categoryAU = new JDialogCustomerAU(jFrameHRMS, true, customer, "Update");
        categoryAU.setVisible(true);
        selectRoomStatus();
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogCustomerAU  categoryAU = new JDialogCustomerAU(jFrameHRMS, true, "Delete", customer);
        categoryAU.setVisible(true);
        selectRoomStatus();
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
  ...
  DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "NAME", "PHONE NUMBER","EMAIL","ADDRESS"}, 0);
    ...
    private void setTable() {
        ...
        column[3] = jTableCategory.getColumnModel().getColumn(4);
        column[3].setPreferredWidth(110);
    ...
    private ArrayList<Customer> roomStatusList;

    private void selectRoomStatus() {
        tableModel.setRowCount(0);
        roomStatusList = customerDAOImpl.selectCustomer();
        tableModel.setRowCount(0);
        for (Customer c : roomStatusList) {
            tableModel.addRow(new Object[]{c.getId(), c.getName(), c.getPhone(),c.getEmail(),c.getAddress()});
        }
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        String name = jTableCategory.getValueAt(row, 1).toString();
                        String phoneNumber = jTableCategory.getValueAt(row, 2).toString();
                        String email = jTableCategory.getValueAt(row, 3).toString();
                        String address = jTableCategory.getValueAt(row, 4).toString();
