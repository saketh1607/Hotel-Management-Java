...
import com.aldrin.hrms.gui.dialog.au.JDialogRoomTypeAU;
 ...
 * @author ALDRIN B. C.
 */
public class JDialogRoomType extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogRoomType(JFrameHRMS jFrameHRMS, boolean modal) {
...
//        jTextFieldSearch.putClientProperty( "JComponent.roundRect",true );
    ...
    private void jButtonNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNewActionPerformed
        JDialogRoomTypeAU categoryAU = new JDialogRoomTypeAU(jFrameHRMS, true);
        categoryAU.setVisible(true);
        selectRoomType();
    }//GEN-LAST:event_jButtonNewActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogRoomTypeAU categoryAU = new JDialogRoomTypeAU(jFrameHRMS, true, roomType, "Update");
        categoryAU.setVisible(true);
        selectRoomType();
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogRoomTypeAU categoryAU = new JDialogRoomTypeAU(jFrameHRMS, true, "Delete", roomType);
        categoryAU.setVisible(true);
        selectRoomType();
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
  ...
  DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "TYPE","CAPACITY", "DESCRIPTION"}, 0);
    ...
    private void setTable() {
        ...
        column[3].setPreferredWidth(480);
    ...
    private void selectRoomType() {
        ...
        roomTypeList = roomTypeDAOImpl.selectRoomType();
        tableModel.setRowCount(0);
        for (RoomType rt : roomTypeList) {
            tableModel.addRow(new Object[]{rt.getId(), rt.getType(),rt.getCapacity(), rt.getDescription()});
        }
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        String type = jTableCategory.getValueAt(row, 1).toString();
                        String capacity = jTableCategory.getValueAt(row, 2).toString();
                        String description = jTableCategory.getValueAt(row, 3).toString();
                        RoomType rt = new RoomType();
                        rt.setId(userId);
                        rt.setType(type);
                        rt.setCapacity(Integer.parseInt(capacity));
