...
import com.aldrin.hrms.gui.dialog.au.JDialogDurationAU;
 ...
 * @author ALDRIN B. C.
 */
public class JDialogDuration extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogDuration(JFrameHRMS jFrameHRMS, boolean modal) {
...
//        jTextFieldSearch.putClientProperty( "JComponent.roundRect",true );
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(595, 416));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButtonNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNewActionPerformed
        JDialogDurationAU storeyAU = new JDialogDurationAU(jFrameHRMS, true);
        storeyAU.setVisible(true);
        selectDuration();
    }//GEN-LAST:event_jButtonNewActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogDurationAU storeyAU = new JDialogDurationAU(jFrameHRMS, true, duration, "Update");
        storeyAU.setVisible(true);
        selectDuration();
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogDurationAU categoryAU = new JDialogDurationAU(jFrameHRMS, true, "Delete", duration);
  ...
  DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "DURATION","MINUTES"}, 0);
    ...
    private ArrayList<Duration> storeyList;

    private void selectDuration() {
        tableModel.setRowCount(0);
        storeyList = durationDAOImpl.selectDuration();
        tableModel.setRowCount(0);
        for (Duration rt : storeyList) {
            tableModel.addRow(new Object[]{rt.getId(), rt.getDuration(),rt.getMinutes()});
        }
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        String duration = jTableCategory.getValueAt(row, 1).toString();
                        Integer minutes = Integer.parseInt(jTableCategory.getValueAt(row, 2).toString());
                        Duration rt = new Duration();
                        rt.setId(userId);
