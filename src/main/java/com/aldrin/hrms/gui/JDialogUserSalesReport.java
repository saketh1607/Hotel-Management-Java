 ...
 */
public class JDialogUserSalesReport extends javax.swing.JDialog {
     ...
     */
    public JDialogUserSalesReport(com.aldrin.hrms.gui.JFrameHRMS parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        com.aldrin.hrms.model.User u = new com.aldrin.hrms.model.User();
//
//        setUserId(userIdl.getId());
////        invoice.setUserAccount(u);
////
////        comboBoxDateAndTimeStart(getUserId());
//        ComboBoxList startIdl = (ComboBoxList) this.jComboBoxFrom.getSelectedItem();
//        setStartId(startIdl.getId());
//
////        comboBoxDateAndTimeEnd(getUserId());
//        ComboBoxList endIdl = (ComboBoxList) this.jComboBoxTo.getSelectedItem();
