...
import com.aldrin.hrms.gui.dialog.au.JDialogRoomAU;
...
public class JDialogRoom extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogRoom(JFrameHRMS jFrameHRMS, boolean modal) {
...
//        jTextFieldSearch.putClientProperty( "JComponent.roundRect",true );
    ...
    private void jButtonNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNewActionPerformed
        JDialogRoomAU categoryAU = new JDialogRoomAU(jFrameHRMS, true);
        categoryAU.setVisible(true);
        selectRoom();
    }//GEN-LAST:event_jButtonNewActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogRoomAU categoryAU = new JDialogRoomAU(jFrameHRMS, true, room, "Update");
        categoryAU.setVisible(true);
        selectRoom();
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogRoomAU categoryAU = new JDialogRoomAU(jFrameHRMS, true, "Delete", room);
        categoryAU.setVisible(true);
        selectRoom();
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
  ...
  DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "TYPE ID", "STATUS ID", "STOREY ID", "ROOM NUMBER", "PRICE", "PRICE UF", "STATUS", "TYPE", "CAPACITY", "STOREY"}, 0);
    ...
    private void setTable() {
        ...
        TableColumn hide1 = jTableCategory.getColumnModel().getColumn(1);
        hide1.setMinWidth(0);
        hide1.setMaxWidth(0);
        hide1.setPreferredWidth(0);
        TableColumn hide2 = jTableCategory.getColumnModel().getColumn(2);
        hide2.setMinWidth(0);
        hide2.setMaxWidth(0);
        hide2.setPreferredWidth(0);
        TableColumn hide3 = jTableCategory.getColumnModel().getColumn(3);
        hide3.setMinWidth(0);
        hide3.setMaxWidth(0);
        hide3.setPreferredWidth(0);
        TableColumn hide6 = jTableCategory.getColumnModel().getColumn(6);
        hide6.setMinWidth(0);
        hide6.setMaxWidth(0);
        ...
        column[3] = jTableCategory.getColumnModel().getColumn(3);
        column[3].setPreferredWidth(110);

        column[3] = jTableCategory.getColumnModel().getColumn(5);
        column[3].setPreferredWidth(110);
...
//"ID", "TYPE ID", "STATUS ID","STOREY ID","ROOM NUMBER","PRICE","STATUS","TYPE","CAPACITY","STOREY"
    ...
    private void selectRoom() {
        ...
        tableModel.setRowCount(0);
        for (Room r : roomList) {
            tableModel.addRow(new Object[]{r.getId(), r.getRoomType().getId(), r.getRoomStatus().getId(), r.getStorey().getId(), r.getRoomNumber(), df.format(r.getPrice()), r.getPrice(), r.getRoomStatus().getStatus(), r.getRoomType().getType(), r.getRoomType().getCapacity(), r.getStorey().getStorey()});
        }
        ...
        if (e.getSource() == jTableCategory) {
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        //"ID", "TYPE ID", "STATUS ID","ROOM NUMBER","PRICE","PRICE UF","STATUS","TYPE","CAPACITY"
                        Long roomId = Long.parseLong(jTableCategory.getValueAt(row, 0).toString());
                        Long typeId = Long.parseLong(jTableCategory.getValueAt(row, 1).toString());
                        Long statusId = Long.parseLong(jTableCategory.getValueAt(row, 2).toString());
                        Long storeyId = Long.parseLong(jTableCategory.getValueAt(row, 3).toString());
                        String roomNumber = jTableCategory.getValueAt(row, 4).toString();
                        Float price = Float.parseFloat(jTableCategory.getValueAt(row, 6).toString());
                        ...
                        st.setId(storeyId);
                        r.setStorey(st);
                        Room uat = roomDAOImpl.findPhotoByRoomId(r);
                        r.setPhoto(uat.getPhoto());
                        this.room = r;
