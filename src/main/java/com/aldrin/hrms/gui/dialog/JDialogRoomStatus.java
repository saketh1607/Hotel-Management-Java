...
import com.aldrin.hrms.gui.dialog.au.JDialogRoomStatusAU;
 ...
 * @author ALDRIN B. C.
 */
public class JDialogRoomStatus extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogRoomStatus(JFrameHRMS jFrameHRMS, boolean modal) {
...
//        jTextFieldSearch.putClientProperty( "JComponent.roundRect",true );
    ...
    private void jButtonNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNewActionPerformed
        JDialogRoomStatusAU categoryAU = new JDialogRoomStatusAU(jFrameHRMS, true);
        categoryAU.setVisible(true);
        selectRoomStatus();
    }//GEN-LAST:event_jButtonNewActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogRoomStatusAU categoryAU = new JDialogRoomStatusAU(jFrameHRMS, true, roomStatus, "Update");
        categoryAU.setVisible(true);
        selectRoomStatus();
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogRoomStatusAU  categoryAU = new JDialogRoomStatusAU(jFrameHRMS, true, "Delete", roomStatus);
        categoryAU.setVisible(true);
        selectRoomStatus();
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
  ...
  DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "STATUS", "DESCRIPTION"}, 0);
    ...
    private void selectRoomStatus() {
        ...
        roomStatusList = roomStatusDAOImpl.selectRoomStatus();
        tableModel.setRowCount(0);
        for (RoomStatus rs : roomStatusList) {
            tableModel.addRow(new Object[]{rs.getId(), rs.getStatus(), rs.getDescription()});
        }
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        String status = jTableCategory.getValueAt(row, 1).toString();
