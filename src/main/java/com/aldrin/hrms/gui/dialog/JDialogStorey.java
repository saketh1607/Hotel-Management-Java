 ...
 * @author ALDRIN B. C.
 */
public class JDialogStorey extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogStorey(JFrameHRMS jFrameHRMS, boolean modal) {
...
//        jTextFieldSearch.putClientProperty( "JComponent.roundRect",true );
    ...
    private void jButtonNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNewActionPerformed
        JDialogStoreyAU storeyAU = new JDialogStoreyAU(jFrameHRMS, true);
        storeyAU.setVisible(true);
        selectStorey();
    }//GEN-LAST:event_jButtonNewActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogStoreyAU storeyAU = new JDialogStoreyAU(jFrameHRMS, true, storey, "Update");
        storeyAU.setVisible(true);
        selectStorey();
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogStoreyAU categoryAU = new JDialogStoreyAU(jFrameHRMS, true, "Delete", storey);
  ...
  DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "STOREY"}, 0);
    ...
    private void selectStorey() {
        tableModel.setRowCount(0);
        storeyList = storeyDAOImpl.selectStorey();
        tableModel.setRowCount(0);
        for (Storey rt : storeyList) {
            tableModel.addRow(new Object[]{rt.getId(), rt.getStorey()});
        }
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        ...
                        String storey = jTableCategory.getValueAt(row, 1).toString();
                        Storey rt = new Storey();
                        rt.setId(userId);
                        rt.setStorey(storey);
                        this.storey = rt;
